...
export class NavigationService {
  ...
  private allLinks: NavItem[] = [
    ...
    { label: 'Gestión de Noticias', path: '/dashboard/administracion/gestion-noticias', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', roles: ['admin'] },
    { label: 'Asignación de Materias', path: '/dashboard/administracion/asignacion-materias', icon: 'M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4', roles: ['admin'] },
    { label: 'Profesores', path: '/dashboard/gestion-profesores', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z', roles: ['admin'] },
